...
#include "oc_rocksdb_block_builder.h"
...
namespace ocssd{
    static void OCPutFixed32(oc_buffer *dst, uint32_t value)
    {
    ...
    {
      char buf[5];
      char *ptr = rocksdb::EncodeVarint32(buf, v);
      dst->append(buf, ptr - buf);
    }

    static void OCPutVarint32Varint32Varint32(oc_buffer* dst, uint32_t v1,
                                    uint32_t v2, uint32_t v3) {
      char buf[15];
      char* ptr = rocksdb::EncodeVarint32(buf, v1);
      ptr = rocksdb::EncodeVarint32(ptr, v2);
      ptr = rocksdb::EncodeVarint32(ptr, v3);
    ...
    Slice BlockBuilder::Finish() {
      ...
      for (size_t i = 0; i < restarts_.size(); i++) {
        OCPutFixed32(buffer_, restarts_[i]);
      }
      OCPutFixed32(buffer_, static_cast<uint32_t>(restarts_.size()));
      finished_ = true;
      return Slice(buffer_->toString());
    }
    ...
    void BlockBuilder::Add(const Slice& key, const Slice& value) {
      ...
      OCPutVarint32Varint32Varint32(buffer_, static_cast<uint32_t>(shared),
